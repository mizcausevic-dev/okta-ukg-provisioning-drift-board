# Okta UKG Provisioning Drift Board

Provisioning drift board for Okta app access and UKG worker-state mismatches.

![ci](https://github.com/mizcausevic-dev/okta-ukg-provisioning-drift-board/actions/workflows/ci.yml/badge.svg)
...
- Live surface: https://mizcausevic-dev.github.io/okta-ukg-provisioning-drift-board/
